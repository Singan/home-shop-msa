...
public class KafkaConfig {
    ...
    public ProducerFactory<String, StockDecreaseDto> producerFactory1() {
        ...
        configProps.put(JsonDeserializer.TYPE_MAPPINGS,
                "stockDecreaseDto:com.example.service.payment.infrastructure.product.dto.StockDecreaseDto");
        return new DefaultKafkaProducerFactory<>(configProps);
    }

    @Bean
    public KafkaTemplate<String, OrderStatusConfirmDto> kafkaTemplate2(ProducerFactory<String, OrderStatusConfirmDto> producerFactory2) {
        return new KafkaTemplate<>(producerFactory2);
    }

    @Bean
    public ProducerFactory<String, OrderStatusConfirmDto> producerFactory2() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, servers);
        configProps.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
